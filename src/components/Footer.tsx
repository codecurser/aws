...
const Footer = () => {
    return (
        <footer className="bg-[#DFA8F0] border-t border-[#7C3AED]/20 pt-20 pb-10 relative overflow-hidden">
            {/* Footer Decor */}
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                    <div className="col-span-1 md:col-span-1">
                        ...
                        <p className="text-[#2D1B36] text-sm leading-relaxed mb-6">
                        ...
                        <div className="flex space-x-4">
                            <a href="#" className="w-10 h-10 rounded-full bg-white shadow-[0_4px_20px_rgba(124,58,237,0.05)] flex items-center justify-center text-[#2D1B36] hover:bg-india-saffron hover:text-[#4C1D95] transition-all transform hover:-translate-y-1"><Twitter size={18} /></a>
                            <a href="#" className="w-10 h-10 rounded-full bg-white shadow-[0_4px_20px_rgba(124,58,237,0.05)] flex items-center justify-center text-[#2D1B36] hover:bg-india-blue hover:text-[#4C1D95] transition-all transform hover:-translate-y-1"><Linkedin size={18} /></a>
                            <a href="#" className="w-10 h-10 rounded-full bg-white shadow-[0_4px_20px_rgba(124,58,237,0.05)] flex items-center justify-center text-[#2D1B36] hover:bg-rani-pink hover:text-[#4C1D95] transition-all transform hover:-translate-y-1"><Instagram size={18} /></a>
                        </div>
                    </div>

                    <div>
                        <h4 className="text-[#4C1D95] font-bold mb-6 font-display text-lg border-b border-[#7C3AED]/20 pb-2 inline-block">Explore</h4>
                        <ul className="space-y-3 text-sm text-[#2D1B36]">
                    ...
                    <div>
                        ...
                        <p className="text-[#2D1B36] text-sm mb-4">
                ...
                <div className="border-t border-[#7C3AED]/20 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-[#2D1B36]">
