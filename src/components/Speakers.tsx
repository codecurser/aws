...
export const Team = () => {
    ...
    const members: TeamMember[] = [
        ...
        { name: 'Aryan Sharma',          role: 'Member · Program & Content',             image: imgAryanSharma,      accentFrom: 'from-violet-500', accentTo: 'to-purple-700', linkedin: 'https://linkedin.com/in/aryan-sharma-9a84142bb'},
